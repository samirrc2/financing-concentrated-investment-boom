...
live value still matches -- a difference is a filer restatement since 2-4 September 2026, not an
    ...
    if a.live:
        ...
        for t in tags:
            ...
            same = "MATCHES the frozen copy" if live == frozen else \
                   f"DIFFERS from the frozen ${frozen/1e9:.3f}bn - filer restatement since the freeze"
