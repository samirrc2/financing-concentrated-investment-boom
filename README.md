...
**Zenodo DOI:** [10.5281/zenodo.22392416](https://doi.org/10.5281/zenodo.22392416) — the permanent citable archive (concept DOI; always resolves to the latest version)
...
LICENSE                   code MIT · derived data/text CC-BY-4.0 · SEC filings reusable, BLS public domain
...
manuscript.docx           Word version, generated from manuscript.tex by code/make_docx.py
...
code/
  ...
  make_docx.py            manuscript.tex -> manuscript.docx (tables, figure, equations)
  ...
  collect_deflator.py     BLS public timeseries API -> WPUFD41312 annual averages
...
deflator from BLS series **WPUFD41312** (Final demand–Private capital equipment), fetched by
`code/collect_deflator.py`. The
...
SEC EDGAR public filing content is freely accessible and
reusable; BLS published material is in the U.S. public domain. See `LICENSE`.
